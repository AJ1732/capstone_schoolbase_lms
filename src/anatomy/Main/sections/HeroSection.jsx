  ...
  return (
    <section className="full-width content-grid | w-full min-h-[515px] bg-image ">
      <div className="content | size-full | flex justify-between items-center">
        <div className='flex flex-col justify-center items-start gap-5 ml-16'>
          <h2 className='font-extrabold text-4xl text-white tracking-wider mt-5 ml-3'>Transforming Education </h2>
          <h2 className='font-extrabold text-4xl text-white tracking-wider ml-3'>with our <span className='text-[#007BFF]'>Versatile LMS</span> </h2>
